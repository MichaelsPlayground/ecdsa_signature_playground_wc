...
class EcdsaCurveP256Sha1SignatureVerificationRoute extends StatefulWidget {
  const EcdsaCurveP256Sha1SignatureVerificationRoute({Key? key}) : super(key: key);

  final String title = 'ECDSA SHA-1 Verifikation';
...
class _MyFormPageState extends State<EcdsaCurveP256Sha1SignatureVerificationRoute> {
  @override
  void initState() {
    super.initState();
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            if (algorithm != 'ECDSA curve P256 SHA-1') {
                              outputController.text =
  ...
  Future<bool> ecdsaVerifiySignatureFromBase64Wc(EcdsaPublicKey publicKey,
    ...
    try {
      ...
      var verificationResult = await publicKey.verifyBytes(
          signature, messageByte, Hash.sha1);
